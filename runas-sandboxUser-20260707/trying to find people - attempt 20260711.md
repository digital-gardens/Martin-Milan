...
but a VM is too heavyweight for my needs, so I want to use a second Windows user account instead


---

when, days ago, I prepared some searches,
...
1. **Plain description of your actual goal** (best signal-to-noise so far):
   ...
   - `separate windows account to isolate untrusted apps`
