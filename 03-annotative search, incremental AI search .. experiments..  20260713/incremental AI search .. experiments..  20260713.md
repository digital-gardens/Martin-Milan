...
// btw, repeated letters in the hashtags are a way to indicate relative importance, e.g. #a < #aa < #aaa < #aaaa < #aaaaa ... etc. 

 (I use this in my own notes, and I think it is a useful convention for the AI to learn as well.)
