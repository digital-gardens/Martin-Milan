...
yyyy
grep -R -E   -i   --no-filename      '^ *[-+*#]+ .{0,10}[-+*#]+'  "C:\Users\marti\OneDrive\Dokumenty\0111--songs--music--lyrics----písně--texty\00-GREP"   | sed -E 's/^( *[-] +)[#]{6,}/\1/'  >"C:\Users\marti\OneDrive\Dokumenty\00-MM\0111--songs--music--lyrics----písně--texty\grep---aaa.txt.md"
