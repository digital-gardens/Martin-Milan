...
Invoke-Item "$env:OneDrive\Dokumenty\00-MM\011*.publ.dir"
explorer.exe (Convert-Path "$env:OneDrive\Dokumenty\00-MM\011*.publ.dir")
(Get-Item "$env:OneDrive\Dokumenty\00-MM\011*.publ.dir").FullName
