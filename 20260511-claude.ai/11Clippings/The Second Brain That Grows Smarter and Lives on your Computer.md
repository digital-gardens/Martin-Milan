...
source: "https://talirezun.substack.com/p/the-second-brain-that-grows-smarter"
author:
  - "[[Dr. Tali Režun]]"
published: 2026-04-15
created: 2026-05-11
description: "How a spark from Andrej Karpathy, a free note-taking app called Obsidian, and a locally-hosted tool, “The Curator”, I built are changing the way I think — permanently."
tags:
  - "clippings"
---
...
What I eventually built — and what I want to share with you — is called [The Curator](https://github.com/talirezun/the-curator). But the story of how it came to be starts with someone else’s idea. And it starts with a concept so elegantly simple that I had to sit with it for a while before I understood just how powerful it really was.
...
## The Architecture of a Second Brain: Entities, Concepts, and Summaries
...
Entities are the nouns. Specific people, companies, tools, datasets, institutions — anything with a proper name. Tali Režun is an Entity. Google DeepMind is an Entity. GPT is an Entity. Each Entity gets its own dedicated page that accumulates facts, context, and connections over time.
...
Summaries are the narratives. Each source you ingest — each article, paper, or document — gets a Summary page that distils its key takeaways and ties together the Entities and Concepts it introduced or mentioned.
...
![](https://substackcdn.com/image/fetch/$s_!dsim!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5aef3138-24ef-4338-8db5-0320df4e51af_1400x881.png)
...
First, you set your domains folder — either pointing to an existing Obsidian vault or choosing any folder on your hard drive. Second, you provide an API key for the AI engine. The default is Google Gemini 2.5 Flash Lite, which has a generous free tier and extremely low cost for paid usage — making this system essentially free to run for most people. Anthropic’s Claude API is also supported, and local LLM support is in development. Third, if you want to sync your knowledge base across multiple computers, you connect a private GitHub repository.

That is the entire setup. From there, the app is organised into six clear sections.

## The Six Sections of The Curator

![](https://substackcdn.com/image/fetch/$s_!15v6!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F90dc7419-3e43-4608-a508-cf4560a97042_1400x894.png)

The Domains section is where you manage your knowledge domains — creating, naming, and organising the topic areas of your Second Brain. Each domain can hold a specific focus: AI and Technology, Business Strategy, Medical Research, Personal Journal — anything you want.

![](https://substackcdn.com/image/fetch/$s_!CFat!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcdb6b951-7efa-4d59-91a2-211410f874ee_1400x722.png)

The Ingest section is the engine room. Drop in a PDF, a plain text file, or a markdown file, and the AI reads it, decomposes it into Entity, Concept, and Summary pages, updates any existing relevant pages with new information, and writes everything directly to your vault. The knowledge graph in Obsidian updates in real time.

![](https://substackcdn.com/image/fetch/$s_!tayK!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F71e53ac7-1982-4ab5-a7a8-098e9ab0a8ce_1400x902.png)

The Chat section lets you have multi-turn AI conversations with your entire Second Brain. Ask it to synthesise across sources. Look for patterns. Query it on specific topics. Every answer is grounded in your own knowledge and cites the exact wiki pages it drew from.

![](https://substackcdn.com/image/fetch/$s_!z9xf!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4cae2e27-d13e-4232-aaf8-ebcf168603e3_1400x1128.png)

The Wiki section gives you a simple browser for reading your generated pages directly within the app — useful for a quick check without opening Obsidian.

![](https://substackcdn.com/image/fetch/$s_!WlZm!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1e9e937f-bcc2-42fe-bb58-b91fc245f160_1400x951.png)

The Sync section manages the GitHub-based synchronisation system. Whether you are pushing your knowledge to a private repository or pulling updates on a different computer, the process is a single click. The recommended general sync option pulls remote changes first, then pushes local ones — the safest choice for everyday use across multiple machines.

![](https://substackcdn.com/image/fetch/$s_!HkzX!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F603594bd-b72d-489d-80e6-e1cee3cccec0_1400x954.png)

The Settings section is where you manage API keys, check the current app version, and pull updates. The app is actively developed and updates regularly.

You can find The Curator on GitHub at: github.com/talirezun/the-curator
...
The Curator itself runs entirely on your local machine — there is no cloud service, no account, no subscription. The AI processing happens via API calls to your Google or Anthropic account — the data flows through your keys. And the sync system uses a private GitHub repository that only you control.
...
The Curator is open source and available at github.com/talirezun/the-curator. The installation for Mac is a single command. The AI model that powers it has a free tier. Obsidian is free. The entire system can be up and running in under fifteen minutes.

You do not need to be technical. You do not need to understand markdown, graph theory or the difference between RAG and compiling wikis. You just need to have knowledge worth keeping — and the patience to let the system compound.
...
— https://talirezun.com/  
— [https://x.com/talirezun](https://x.com/talirezun)  
— [https://www.linkedin.com/in/talirezun](https://www.linkedin.com/in/talirezun)  
— [https://www.researchgate.net/profile/Tali-Rezun](https://www.researchgate.net/profile/Tali-Rezun)

[Dr. Tali Režun](https://talirezun.substack.com/?utm_source=substack&utm_campaign=publication_embed&utm_medium=web)
...
We have not been compensated, sponsored, or otherwise financially supported by any of the companies, platforms, or tools mentioned in this article. All opinions, assessments, and recommendations are my own and based solely on independent research and practical experience.
